...
public class King extends Piece{
    ...
    public boolean hasEscapeMoves(){
        return !(board.checkScanner.isKingChecked(new Move(board, this, this.col, this.row + 1)) &&
                board.checkScanner.isKingChecked(new Move(board, this, this.col, this.row - 1)) &&
                board.checkScanner.isKingChecked(new Move(board, this, this.col + 1, this.row)) &&
                board.checkScanner.isKingChecked(new Move(board, this, this.col - 1, this.row)) &&
                board.checkScanner.isKingChecked(new Move(board, this, this.col - 1, this.row - 1)) &&
                board.checkScanner.isKingChecked(new Move(board, this, this.col + 1, this.row + 1)) &&
                board.checkScanner.isKingChecked(new Move(board, this, this.col - 1, this.row + 1)) &&
                board.checkScanner.isKingChecked(new Move(board, this, this.col + 1, this.row - 1)));
    }
